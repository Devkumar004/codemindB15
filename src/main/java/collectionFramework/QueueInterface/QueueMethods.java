...
public class QueueMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("_____________________________________________");
		// System.out.println("To get the element in array : " + L.get(3));// Mostly
		// used. method not allowed
		System.out.println("____________________________________________");
		// System.out.println("To find the index of element : " + L.indexOf(60));method
		// not allowed
		System.out.println("_____________________________________________");
		...
		// System.out.println("view of the list from index 1 (inclusive) to index 3
		// (exclusive) : " + L.subList(1, 3)) method not allowed
		System.out.println("_____________________________________________");
		...
		/*
		 * System.out.println("_____________________________________________");
		 * Queue<String> l11 = new Queue<String>(Arrays.asList("Sachin", "Saurav",
		 * "hardik"));
